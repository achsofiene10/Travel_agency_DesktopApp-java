...
public class Vols extends JFrame implements MouseListener, FocusListener, ActionListener {
	...
	public Vols() throws SQLException {
	 ...
	 void initialize() throws SQLException  {
		...
		scrollPane.setBounds(80, 50, 850, 515);
		...
		while (this.rs.next()) {
			...
			Panneau p=new Panneau(t[0],t[1],t[2],t[3],t[4],t[5],t[6],t[7],ch,t[9],t[11],lblConx.getText());
			panelscroll.add(p);
		}
        panelscroll.setPreferredSize(new Dimension(850,nblig*150)); // Height doit etre proportionnele aux nombres de panneaux
	        ...
	        lblVolsDiponibles.setBounds(80, 15, 462, 25);
