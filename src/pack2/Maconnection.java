...
public class Maconnection {
	...
	public ResultSet selection1 (String req) throws SQLException {
		return st1.executeQuery(req);
	}
	
	public int suppression(String req) throws SQLException {
		return st.executeUpdate(req);
	}

	public int modify(String req) throws SQLException {
			return st.executeUpdate(req);
	}
