...
public class Monmodel1 extends AbstractTableModel {
	ResultSet rs;
	...
	int nbcol;
	Maconnection maconx;
	public Monmodel1 (ResultSet rs) throws SQLException{
		this.rs=rs;
	...
	public void setValueAt(Object aValue, int rowIndex,int  columnIndex) {
		...
		String ch="UPDATE reservations set "+name+"= '"+aValue.toString()+"' where numres = "+t[0];
		try {
	...
	public void supprimer(int row,int col) {
		...
		String sup="DELETE FROM `reservations` WHERE "+c+" = '"+t.toString()+"' ;";
	...
	public void ajouter(Object[] t1) {
		...
		tab.add(t1);
		nblig++;
		String ajout="Insert into reservations values( "+t1[0]+",'"+t1[1]+"','"+t1[2]+"','"+t1[3]+"','"+t1[4]+"','"+t1[5]+"','"+t1[6]+"','"+t1[7]+"','"+t1[8]+"','"+t1[9]+"','"+t1[10]+"')" ; 
		try {
