...
public class ClientsEdit extends JFrame implements ActionListener {
	...
	void initialize() {
		...
		btnNew.setText("<html>Nouveau<br />client</html>");
		btnEdit.setText("<html>Modifier<br /></html>");
		btnDelete.setText("<html>Supprimer<br />client</html>");
		...
		JLabel lblLaListeDe = new JLabel("La liste des clients\r\n");
	...
	extends DefaultTableCellRenderer {
		public Component getTableCellRendererComponent(JTable table,
			...
			if (row == 0 && column ==0) {
				...
				c.setBackground(new Color(132, 226, 255));
			}
			return c;
		}
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==btnNew) {
			Newclient newvol=new Newclient(mod);
